...
public class ArenaManager {
  ...
  public static void startWave(@NotNull Arena arena) {
    ...
    arena.setOptionValue(ArenaOption.ZOMBIES_TO_SPAWN, 1);
    ...
    if (config == null) {
      ...
      if (wave == null) {
        ...
        if (arena.getOption(ArenaOption.ZOMBIE_DIFFICULTY_MULTIPLIER) < 1) {
          arena.setOptionValue(ArenaOption.ZOMBIE_DIFFICULTY_MULTIPLIER, 1);
        }
        arena.setOptionValue(ArenaOption.ZOMBIES_TO_SPAWN, wave.randomMobAmount());
      }
    }
